...
const title = 'Notion vs MoneySystem | The #1 Open Source Notion Alternative is MoneySystem';
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      siteName: 'MoneySystem',
      images: [
        {
          url: `${site_url}/blog-og-image.png`,
          width: 1200,
          height: 630,
          alt: 'The Best Open Source Notion Alternative - MoneySystem',
        },
      ],
    },
    keywords:
...
const points = ['Offline mode', 'Self-hosting', 'Facilidade no Uso', 'Customization', 'Native mobile and desktop apps'];
          ...
          <div className={'af-box section-2'}>
            ...
            <div className={'cards'}>
              ...
              <div className={'card'}>
                ...
                <div className={'card-title'}>
                  ...
                  <div className={'card-desc'}>Self-host MoneySystem wherever you want, no vendor lock-in.</div>
                </div>
              </div>
            ...
            >
              <div className={'flex w-full items-center justify-between'}>
                ...
                <div className="w-1/4 px-[48px] py-6 text-center text-[#58585a] max-md:px-4 max-md:py-4">MoneySystem</div>
              </div>
              {points.map((point) => (
                <div
                  key={point}
