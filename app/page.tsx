      ...
      <div className={'af-container'}>
        <div className={'af-box section-1'}>
          <div className={'main-content'}>
            <h1>
            Mais tempo <span className={'text-primary'}>para você.</span> Mais resultado para a <span className={'text-primary'}>sua empresa.</span>
            </h1>
      ...
      <div id="sobrenos" className={'af-container'}>
        <div className={'af-box section-3'}>
          ...
          <div className={'flex w-full flex-col items-center justify-center gap-[80px] pt-[26px] max-md:gap-10'}>
            <div className={'section-3-subtitle gradient-text'}>Acessível, colaborativo e prático<span className={'text-[#6cb640]'}></span>
            </div>
            <div className={'cards'}>
              <div className={'card'}>
                <div className="glow"></div>
          ...
          <div className={'cards'}>
            ...
            <div className={'card'}>
              ...
              <div className={'card-title'}>
                ...
                <div className={'card-desc'}>
                  {`Emita notas fiscais com mais rapidez e de forma automatizada.`}
                </div>
              </div>
            </div>
            <div className={'card'}>
      ...
      <div className={'af-container'}>
        <div className={'af-box section-6'}>
          <div className={'section-6-title'}>
            Use
            <span className={'text-primary'}> na palma de sua mão </span>
            em qualquer lugar
          </div>
        </div>
      </div>
