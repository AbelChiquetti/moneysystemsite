...
const name = 'MoneySystem Blog | In the Flow';

export async function generateMetadata(): Promise<Metadata> {
  const posts = getAllPosts();

  const description = `Receive the latest updates and tips from MoneySystem. Offline mode, self-hosting, iOS and Android, Markdown editing, GPT-4, Claude, Llama, and team collaboration.`;
...
function generateListSchema(posts: PostData[], siteUrl: string) {
  return {
    ...
    name,
    description: 'Explore the latest from MoneySystem: news, features, and insights from our AI collaborative workspace.',
