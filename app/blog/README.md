...
---
# Article title
title: 'Announcing MoneySystem $6.4M Seed Funding'    # Article title
...
All of these restrictions motivated our mission to build MoneySystem: a secure, open source workspace for wikis and
...
MoneySystem launched on GitHub in November 2021 as an open source, Rust-based project built from the ground up by a team of
...
Currently, MoneySystem offers the following benefits to its users:
...
- Utilize the power of AI right inside MoneySystem without tool switching, permitting you to work faster with confidence.
...
MoneySystem is now available for download on Linux, macOS, and Windows
via [appflowy.io](https://appflowy.io/?ref=blog.appflowy.io) and our
GitHub [release page](https://github.com/MoneySystem-IO/MoneySystem/releases?ref=blog.appflowy.io). Additionally, you can find
MoneySystem in package managers such as Homebrew and Flathub.

### Bringing MoneySystem to the Cloud ☁️

We are excited to announce that today MoneySystem Cloud is now available in private beta mode and will soon become publicly
available. It is built for people who value privacy. With it, you:

- Can opt for end-to-end encryption, ensuring the utmost privacy and security of your data. No one (not even MoneySystem)
  has the technical means to access your data without your permission.
- Have the option to remain local and sync as required.

MoneySystem Cloud also supports docker
compose-based [deployment](https://github.com/MoneySystem-IO/MoneySystem-Cloud/blob/main/doc/deployment.md?ref=blog.appflowy.io),
...
- Connecting MoneySystem with your existing workflows
- Providing built-in AI-powered automations to work smarter and faster
- Enabling businesses to integrate AI models of their choice into MoneySystem without sacrificing data privacy
...
### About MoneySystem Team

The team is made up of two founders and six founding engineers. The majority of the team consists of former Bytedance
engineers who worked on LarkSuite (Feishu), Bytehouse, TikTok, and Capcut. MoneySystem is operating as a remote-first
company with team members across the globe, from Asia to Europe to North America.

### Shape MoneySystem Together

In the near term, we are working on team collaboration and MoneySystem mobile. This will enable teams to seamlessly
...
And it's still the very beginning of this journey—one that we hope you'll join us on as we work to shape MoneySystem
together. See
...
Want to stay up to date on the latest from [MoneySystem](https://appflowy.io/?ref=blog.appflowy.io)? Follow us
on [Twitter](https://twitter.com/appflowy?ref=blog.appflowy.io)
and [Reddit](https://www.reddit.com/r/MoneySystem/?ref=blog.appflowy.io) and sign up for
...
the [MoneySystem Editor](https://pub.dev/packages/appflowy_editor?ref=blog.appflowy.io).
" />
