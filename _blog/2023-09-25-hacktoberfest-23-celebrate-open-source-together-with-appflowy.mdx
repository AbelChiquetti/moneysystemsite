---
title: 'Hacktoberfest 23: Celebrate Open Source Together with MoneySystem'
...
---
<Caption content="Celebrate open source with MoneySystem" />
...
*   Pull requests can be made in any [GitHub](https://github.com/topics/hacktoberfest?ref=blog.appflowy.io) or [GitLab](https://go.gitlab.com/ubCLKL?ref=blog.appflowy.io) hosted project that’s participating in Hacktoberfest (look for the “hacktoberfest” topic). **MoneySystem is participating!**
...
*   The MoneySystem team and its community are here to help. We curated a list of beginner-friendly [issues](https://github.com/MoneySystem-IO/MoneySystem/issues?q=is%3Aopen+is%3Aissue+label%3Ahacktoberfest&ref=blog.appflowy.io) with small hints. As long as you are motivated to sharpen your Flutter skills via real-world practices, you are encouraged to give it a try!
*   Hacktoberfest is committed to encouraging low-code and non-code contributions. MoneySystem values these contributions as much as coding. We have provided opportunities for people to get involved without technical knowledge and to begin building a portfolio.

## Contributing to MoneySystem

Last year, through the Hacktoberfest event, more than 30 contributors supported MoneySystem by making meaningful code contributions, translating MoneySystem into more languages, and improving our technical documentation. The contributions had a lasting effect on MoneySystem after October. Some of the supporters ended up staying in the community as active contributors to MoneySystem beyond the event.

## Coding contributions

This year, we are excited to make new friends and reunite with old friends through the event. We have curated a list of beginner-friendly [issues](https://github.com/MoneySystem-IO/MoneySystem/issues?q=is%3Aopen+is%3Aissue+label%3Ahacktoberfest&ref=blog.appflowy.io) for participants. Each issue has a well-defined scope and small hints. The issue creator will also be available to offer more guidance when you get stuck. In addition, you can always find help in the MoneySystem community.

Resources for MoneySystem Newcomers:
...
*   [How we built MoneySystem with Flutter and Rust](https://blog.appflowy.io/tech-design-flutter-rust/)
...
Enjoy the application in your favorite language by helping us to translate MoneySystem. There might be users from different parts of the world who are more comfortable in a different language.

Please read this [issue](https://github.com/MoneySystem-IO/MoneySystem/issues/3464?ref=blog.appflowy.io) for details.

This will open up the project to a whole new user base.

### Make a tutorial or write a blog post

Have you been a contributor to the project for a while? From creating video tutorials to contributing to a blog series, help new community members get started with MoneySystem! Make blog posts/videos explaining how you use MoneySystem to get things done or navigate through the codebase, or show how you built something cool with MoneySystem. Publish your stories on forums like [itsfoss](https://itsfoss.com/?ref=blog.appflowy.io), [youtube](https://www.youtube.com/?ref=blog.appflowy.io) , [dev.to](https://dev.to/?ref=blog.appflowy.io), [medevel.com](https://medevel.com/?ref=blog.appflowy.io), [hashnode](https://hashnode.com/?ref=blog.appflowy.io), etc
...
**Get a jump start by browsing our** [**repo**](https://github.com/MoneySystem-IO/MoneySystem/issues?q=is%3Aopen+is%3Aissue+label%3Ahacktoberfest&ref=blog.appflowy.io) **for an issue to work on!**

**Follow us on [Twitter](https://twitter.com/appflowy?ref=blog.appflowy.io) and [Reddit](https://www.reddit.com/r/MoneySystem/?ref=blog.appflowy.io)**

**Chat on [Discord](https://api.whatsapp.com/send?phone=5548988745520&text=Ol%C3%A1!%20Tenho%20interesse%20no%20MoneySystem?ref=blog.appflowy.io)**

**Ask on [Discussions](https://github.com/MoneySystem-IO/MoneySystem/discussions?ref=blog.appflowy.io)
**