...
export const downloadPageConfig = {
  ...
  downloadMobileImgAlt: 'MoneySystem para iOS e Android',
...
export const aboutPageConfig = {
...

    {
      ...
      desc: (
        <div className={'our-mission-desc'}>
          <div>MoneySystem - a secure, open source workspace for wikis and projects, made to suit everyone.</div>
          <div className={'list'}>
            <div>Put control of your data in your hands</div>
            <div>Ensure the user interface is fast and intuitive.</div>
            <div>
              Make integration and customization easy with no vendor lock in. Add MoneySystem into your existing workflows
              or build a customized workspace with our open source building blocks such as MoneySystem Editor and Kanban
              Board.
            </div>
            <div>
              Build an open source codebase with a community-driven open toolbox of plugins, templates, and themes so you
              can design and modify MoneySystem your way without limits.
            </div>
          </div>
        </div>
      ),
  ...
  developers: {
    title: 'Aprovado pelas maiores empresas',
    logos: [
      {
        name: 'grupor5brasil',
        logo: '/images/MoneySystem.svg',
        darkLogo: '/images/MoneySystem.svg',
      },
      {
        name: 'lunarfilm',
        logo: '/images/MoneySystem.svg',
  ...
  values: [
    {
      ...
      list: [
        ...
        'We actively lead and support the MoneySystem open-source community, where a diverse group of people is empowered to contribute to the common good.',
    ...
    },
    {
      title: 'Transparency',
      list: [
        'We make information about MoneySystem public by default unless there is a compelling reason not to.',
...
export const joinPageConfig = {
  ...
  jobs: [
    ...
    // },
    {
      ...
      link: 'https://apply.workable.com/appflowy/j/D00DA4DE03/',
    },
  ],
};
...
export const contactPageConfig = {
  ...
  desc: (
    <span>
      ...
      <br />
      ask in our{' '}
      <Link target={'_blank'} className={'link'} href={'https://api.whatsapp.com/send?phone=5548988745520&text=Ol%C3%A1!%20Tenho%20interesse%20no%20MoneySystem'}>
        Discord community
      </Link>
      <br />
...
/**
 * MoneySystem Blocks Page
 */
export const blocksPageConfig = {
  title: 'MoneySystem Blocks',
  subtitle:
    'MoneySystem is not only an open-source alternative to Notion but an application infra provider as well. We publish reliable and customizable standalone building blocks such as MoneySystem Editor and Kanban Board for developers to build their own applications.',
  blocks: [
    {
      title: 'MoneySystem Editor',
      desc: 'A highly customizable rich-text editor for Flutter',
      imageSrc: editor.src,
      imageDarkSrc: darkEditor.src,
      imageAlt: 'MoneySystem Editor',
      link: 'https://pub.dev/packages/appflowy_editor',
      imageWidth: 538,
      imageHeight: 335,
    },
    {
      title: 'MoneySystem Board',
      desc: 'A customizable and draggable Kanban Board widget',
      imageSrc: board.src,
      imageDarkSrc: darkBoard.src,
      imageAlt: 'MoneySystem Board',
