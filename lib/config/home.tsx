...
export const heroSectionConfig = {
  ...
  subtitle: (
    <span>
      <span className={'bold'}>MoneySystem </span>
...
export const productShowCaseConfig = {
  ...
  secondImgAlt: 'MoneySystem\'s product showcase',
  ...
  features: [
    {
      title: 'No tool\nswitching',
      icon: <Checkbox />,
      desc: 'You can enjoy the full power of AI right inside of MoneySystem.',
    },
    {
      title: 'Data\ncontrol',
      icon: <Folder />,
...
export const dataSecurityConfig = {
  ...
  cards: [
    {
      title: 'Cresça mais',
      desc: 'Automatize processos e ganhe tempo para focar no crescimento do negócio',
      icon: {
        src: dataIcon1.src,
    ...
    },
    {
      ...
      desc: 'Tenha seus dados salvos com segurança na nuvem.',
      icon: {
        src: dataIcon3.src,
...
export const communityConfig = {
  title: (
    <span>
      {`MoneySystem is built with a vibrant `}
      <span className={'primary-word'}>
        community
        <span className={'primary-line'}>
          <svg
  ...
  intros: [
    {
      ...
      content: (
        <>
          ...
          <br />
          <div>
          Junte-se a nós to build a toolbox that empowers anyone to create their own system — play and tweak without limits.
          </div>
        </>
      ),
      btnText: 'Junte-se a nós',
      btnLink: 'https://api.whatsapp.com/send?phone=5548988745520&text=Ol%C3%A1!%20Tenho%20interesse%20no%20MoneySystem',
      image: {
